...
export function DashboardMobile({
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex flex-col items-center px-2 py-4">
      {/* Header */}
      ...
      {/* User Card */}
      <div className="w-full max-w-md rounded-xl bg-white shadow p-4 mb-4">
        <div className="font-semibold text-lg text-neutral-900 mb-1">
          Welcome, {user.name} !
        </div>
        <div className="text-sm text-neutral-500">Email: {user.email}</div>
      </div>
