...
import { login, verifyLoginOTP, resendOTP } from "../lib/authApi";
...
export function SignInCard() {
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await login({ email: form.email.trim() });
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
            ...
            <div className="flex flex-col">
              ...
              <div className="mb-8 flex items-center gap-2">
                <img src="/logo.png" alt="Logo" className="h-7 w-15 rounded" />
              </div>
              ...
              <form onSubmit={step === "email" ? handleEmailSubmit : handleOTPSubmit} className="flex flex-col">
                ...
                {/* Keep me logged in - only show on email step */}
                {step === "email" && (
                ...
                >
                  {loading ? (
                    <>
                      ...
                      {step === "email" ? "Getting OTP..." : "Signing in..."}
                    </>
                  ) : (
